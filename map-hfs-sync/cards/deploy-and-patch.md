...
**Shape:**
- `patch_v3_upsert.ps1` — the canonical example: GETs the live workflow, mutates nodes (remove/rename/add), rebuilds connections, PUTs. This is what turned v2 into v3.
