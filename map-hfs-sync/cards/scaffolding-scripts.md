...
**Hits:** the mutation scripts (deploy/patch/backfill/dedup/fix) write to the live workflow or live Airtable records if re-run; treat them as live mutations, not documentation. The read-only probes hit nothing.
