...
Start here. Open ONE card, then stop. Do not read all 183 files in this folder; that is the tree this map exists to spare you.
...
- Prior-era mapping docs -> cards/prior-era-docs.md — `MASTER_MAPPING.md` + `hfs_schema.md`, earlier plans, partly superseded
...
- Build & diagnostic scripts -> cards/scaffolding-scripts.md — ~165 one-off `.ps1` probes, fixes, and backfills
