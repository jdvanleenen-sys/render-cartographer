...
<!-- Copy to map/cards/ghost_<noun>.md. A ghost is a name with no wiring. Group same-pattern
     ghosts into ONE card. Register its id (not a colliding name) in source-index ghost_fields. -->
